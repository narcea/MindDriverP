/* Intense Learning Pack */

PROGRAM (SBG) Imagistic Learning
...
END
PROGRAM (SBG) Dual Binaural Crosstalk
...
END
PROGRAM (SBG) Foreign Language Helper
...
END
PROGRAM (SBG) Attention and Focus 2
...
END
PROGRAM (SBG) The Suggestive State 2
     DESC, A dual binaural beat program.
